...
const SCRIPT_NPC_HIDDEN = 8
const SCRIPT_SCRIPT_HIDDEN = 9
const SCRIPT_NO_CANCEL = 10
const SCRIPT_BATTLE = 11
const SCRIPT_READ_QUEST = 20
const SCRIPT_WRITE_QUEST = 21
const SCRIPT_CONTINUE_IF = 22
